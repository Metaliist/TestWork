        ...
        var dat = fs_1.readFile(file, 'utf-8', function (err, contents) {
            if (!err) {
                if (contents.length < 1000) {
                    ...
                    var zap = {
                        method: 'POST',
                        url: 'https://speller.yandex.net/services/spellservice.json/checkText?text=' + contents.toString().replace(/ /g, "+"),
                        headers: {
                    ...
                    let z='https://speller.yandex.net/services/spellservice.json/checkText?text=' + contents.toString().replace(/ /g, "+");
                    /*
